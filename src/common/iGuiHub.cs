...
namespace MCS
{
    ...
    [_System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1722")]
    [_System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1724")]
    public partial interface UserManagment : Ice.Object, UserManagmentOperations_, UserManagmentOperationsNC_
    {
    }
}
...
namespace MCS
{
    ...
    [_System.CodeDom.Compiler.GeneratedCodeAttribute("slice2cs", "3.4.2")]
    public delegate void Callback_UserManagment_CreateUser(int ret__);

    [_System.CodeDom.Compiler.GeneratedCodeAttribute("slice2cs", "3.4.2")]
    public delegate void Callback_UserManagment_SetUserPW(int ret__);

    [_System.CodeDom.Compiler.GeneratedCodeAttribute("slice2cs", "3.4.2")]
    public delegate void Callback_UserManagment_SetUserRithg(int ret__);

    [_System.CodeDom.Compiler.GeneratedCodeAttribute("slice2cs", "3.4.2")]
    public delegate void Callback_UserManagment_DeleteUser(int ret__);

    [_System.CodeDom.Compiler.GeneratedCodeAttribute("slice2cs", "3.4.2")]
    public delegate void Callback_UserManagment_GetUserCount(int ret__);

    [_System.CodeDom.Compiler.GeneratedCodeAttribute("slice2cs", "3.4.2")]
    public delegate void Callback_UserManagment_GetUserList(MCS.User[] ret__);
}
...
namespace MCS
{
    ...
    [_System.CodeDom.Compiler.GeneratedCodeAttribute("slice2cs", "3.4.2")]
    public interface UserManagmentPrx : Ice.ObjectPrx
    {
        ...
        Ice.AsyncResult<MCS.Callback_UserManagment_CreateUser> begin_CreateUser(string user, string pass, int session);
        Ice.AsyncResult<MCS.Callback_UserManagment_CreateUser> begin_CreateUser(string user, string pass, int session, _System.Collections.Generic.Dictionary<string, string> ctx__);
        ...
        Ice.AsyncResult<MCS.Callback_UserManagment_SetUserPW> begin_SetUserPW(int nUID, string pass, int session);
        Ice.AsyncResult<MCS.Callback_UserManagment_SetUserPW> begin_SetUserPW(int nUID, string pass, int session, _System.Collections.Generic.Dictionary<string, string> ctx__);
        ...
        int SetUserRithg(int nUID, int nRight, int session);
        int SetUserRithg(int nUID, int nRight, int session, _System.Collections.Generic.Dictionary<string, string> context__);

        Ice.AsyncResult<MCS.Callback_UserManagment_SetUserRithg> begin_SetUserRithg(int nUID, int nRight, int session);
        Ice.AsyncResult<MCS.Callback_UserManagment_SetUserRithg> begin_SetUserRithg(int nUID, int nRight, int session, _System.Collections.Generic.Dictionary<string, string> ctx__);

        Ice.AsyncResult begin_SetUserRithg(int nUID, int nRight, int session, Ice.AsyncCallback cb__, object cookie__);
        Ice.AsyncResult begin_SetUserRithg(int nUID, int nRight, int session, _System.Collections.Generic.Dictionary<string, string> ctx__, Ice.AsyncCallback cb__, object cookie__);

        int end_SetUserRithg(Ice.AsyncResult r__);
        ...
        Ice.AsyncResult<MCS.Callback_UserManagment_DeleteUser> begin_DeleteUser(int nUID, int session);
        Ice.AsyncResult<MCS.Callback_UserManagment_DeleteUser> begin_DeleteUser(int nUID, int session, _System.Collections.Generic.Dictionary<string, string> ctx__);
        ...
        Ice.AsyncResult<MCS.Callback_UserManagment_GetUserCount> begin_GetUserCount();
        Ice.AsyncResult<MCS.Callback_UserManagment_GetUserCount> begin_GetUserCount(_System.Collections.Generic.Dictionary<string, string> ctx__);
        ...
        Ice.AsyncResult<MCS.Callback_UserManagment_GetUserList> begin_GetUserList(int nBegin, int nCount);
        Ice.AsyncResult<MCS.Callback_UserManagment_GetUserList> begin_GetUserList(int nBegin, int nCount, _System.Collections.Generic.Dictionary<string, string> ctx__);
...
namespace MCS
{
    ...
    [_System.CodeDom.Compiler.GeneratedCodeAttribute("slice2cs", "3.4.2")]
    public interface UserManagmentOperations_
    {
        ...
        int SetUserRithg(int nUID, int nRight, int session, Ice.Current current__);
    ...
    [_System.CodeDom.Compiler.GeneratedCodeAttribute("slice2cs", "3.4.2")]
    public interface UserManagmentOperationsNC_
    {
        int CreateUser(string user, string pass, int session);
...
namespace MCS
{
    ...
    [_System.Runtime.InteropServices.ComVisible(false)]
    [_System.CodeDom.Compiler.GeneratedCodeAttribute("slice2cs", "3.4.2")]
    public sealed class UserManagmentPrxHelper : Ice.ObjectPrxHelperBase, UserManagmentPrx
    {
        #region Synchronous operations
        ...
        private int CreateUser(string user, string pass, int session, _System.Collections.Generic.Dictionary<string, string> context__, bool explicitContext__)
        {
            ...
            while(true)
            {
                ...
                try
                {
                    ...
                    delBase__ = getDelegate__(false);
                    UserManagmentDel_ del__ = (UserManagmentDel_)delBase__;
        ...
        public int SetUserRithg(int nUID, int nRight, int session)
        {
            return SetUserRithg(nUID, nRight, session, null, false);
        }

        public int SetUserRithg(int nUID, int nRight, int session, _System.Collections.Generic.Dictionary<string, string> context__)
        {
            return SetUserRithg(nUID, nRight, session, context__, true);
        }

        private int SetUserRithg(int nUID, int nRight, int session, _System.Collections.Generic.Dictionary<string, string> context__, bool explicitContext__)
        {
            if(explicitContext__ && context__ == null)
            {
                context__ = emptyContext_;
            ...
            while(true)
            {
                ...
                try
                {
                    checkTwowayOnly__("SetUserRithg");
                    delBase__ = getDelegate__(false);
                    UserManagmentDel_ del__ = (UserManagmentDel_)delBase__;
                    return del__.SetUserRithg(nUID, nRight, session, context__);
                }
                catch(IceInternal.LocalExceptionWrapper ex__)
                {
                    handleExceptionWrapperRelaxed__(delBase__, ex__, true, ref cnt__);
        ...
        public Ice.AsyncResult<MCS.Callback_UserManagment_CreateUser> begin_CreateUser(string user, string pass, int session)
        {
            return begin_CreateUser(user, pass, session, null, false, null, null);
        }

        public Ice.AsyncResult<MCS.Callback_UserManagment_CreateUser> begin_CreateUser(string user, string pass, int session, _System.Collections.Generic.Dictionary<string, string> ctx__)
        {
        ...
        private Ice.AsyncResult<MCS.Callback_UserManagment_CreateUser> begin_CreateUser(string user, string pass, int session, _System.Collections.Generic.Dictionary<string, string> ctx__, bool explicitContext__, Ice.AsyncCallback cb__, object cookie__)
        {
            checkAsyncTwowayOnly__(__CreateUser_name);
            IceInternal.TwowayOutgoingAsync<MCS.Callback_UserManagment_CreateUser> result__ =  new IceInternal.TwowayOutgoingAsync<MCS.Callback_UserManagment_CreateUser>(this, __CreateUser_name, CreateUser_completed__, cookie__);
            if(cb__ != null)
            {
                result__.whenCompletedWithAsyncCallback(cb__);
            }
        ...
        private void CreateUser_completed__(Ice.AsyncResult r__, MCS.Callback_UserManagment_CreateUser cb__, Ice.ExceptionCallback excb__)
        {
            int ret__;
            try
            {
        ...
        public Ice.AsyncResult<MCS.Callback_UserManagment_DeleteUser> begin_DeleteUser(int nUID, int session)
        {
            return begin_DeleteUser(nUID, session, null, false, null, null);
        }

        public Ice.AsyncResult<MCS.Callback_UserManagment_DeleteUser> begin_DeleteUser(int nUID, int session, _System.Collections.Generic.Dictionary<string, string> ctx__)
        {
        ...
        private Ice.AsyncResult<MCS.Callback_UserManagment_DeleteUser> begin_DeleteUser(int nUID, int session, _System.Collections.Generic.Dictionary<string, string> ctx__, bool explicitContext__, Ice.AsyncCallback cb__, object cookie__)
        {
            checkAsyncTwowayOnly__(__DeleteUser_name);
            IceInternal.TwowayOutgoingAsync<MCS.Callback_UserManagment_DeleteUser> result__ =  new IceInternal.TwowayOutgoingAsync<MCS.Callback_UserManagment_DeleteUser>(this, __DeleteUser_name, DeleteUser_completed__, cookie__);
            if(cb__ != null)
            {
                result__.whenCompletedWithAsyncCallback(cb__);
            }
        ...
        private void DeleteUser_completed__(Ice.AsyncResult r__, MCS.Callback_UserManagment_DeleteUser cb__, Ice.ExceptionCallback excb__)
        {
            int ret__;
            try
            {
        ...
        public Ice.AsyncResult<MCS.Callback_UserManagment_GetUserCount> begin_GetUserCount()
        {
            return begin_GetUserCount(null, false, null, null);
        }

        public Ice.AsyncResult<MCS.Callback_UserManagment_GetUserCount> begin_GetUserCount(_System.Collections.Generic.Dictionary<string, string> ctx__)
        {
        ...
        private Ice.AsyncResult<MCS.Callback_UserManagment_GetUserCount> begin_GetUserCount(_System.Collections.Generic.Dictionary<string, string> ctx__, bool explicitContext__, Ice.AsyncCallback cb__, object cookie__)
        {
            checkAsyncTwowayOnly__(__GetUserCount_name);
            IceInternal.TwowayOutgoingAsync<MCS.Callback_UserManagment_GetUserCount> result__ =  new IceInternal.TwowayOutgoingAsync<MCS.Callback_UserManagment_GetUserCount>(this, __GetUserCount_name, GetUserCount_completed__, cookie__);
            if(cb__ != null)
            {
                result__.whenCompletedWithAsyncCallback(cb__);
            }
        ...
        private void GetUserCount_completed__(Ice.AsyncResult r__, MCS.Callback_UserManagment_GetUserCount cb__, Ice.ExceptionCallback excb__)
        {
            int ret__;
            try
            {
        ...
        public Ice.AsyncResult<MCS.Callback_UserManagment_GetUserList> begin_GetUserList(int nBegin, int nCount)
        {
            return begin_GetUserList(nBegin, nCount, null, false, null, null);
        }

        public Ice.AsyncResult<MCS.Callback_UserManagment_GetUserList> begin_GetUserList(int nBegin, int nCount, _System.Collections.Generic.Dictionary<string, string> ctx__)
        {
        ...
        private Ice.AsyncResult<MCS.Callback_UserManagment_GetUserList> begin_GetUserList(int nBegin, int nCount, _System.Collections.Generic.Dictionary<string, string> ctx__, bool explicitContext__, Ice.AsyncCallback cb__, object cookie__)
        {
            checkAsyncTwowayOnly__(__GetUserList_name);
            IceInternal.TwowayOutgoingAsync<MCS.Callback_UserManagment_GetUserList> result__ =  new IceInternal.TwowayOutgoingAsync<MCS.Callback_UserManagment_GetUserList>(this, __GetUserList_name, GetUserList_completed__, cookie__);
            if(cb__ != null)
            {
                result__.whenCompletedWithAsyncCallback(cb__);
            }
        ...
        private void GetUserList_completed__(Ice.AsyncResult r__, MCS.Callback_UserManagment_GetUserList cb__, Ice.ExceptionCallback excb__)
        {
            MCS.User[] ret__;
            try
            {
        ...
        public Ice.AsyncResult<MCS.Callback_UserManagment_SetUserPW> begin_SetUserPW(int nUID, string pass, int session)
        {
            return begin_SetUserPW(nUID, pass, session, null, false, null, null);
        }

        public Ice.AsyncResult<MCS.Callback_UserManagment_SetUserPW> begin_SetUserPW(int nUID, string pass, int session, _System.Collections.Generic.Dictionary<string, string> ctx__)
        {
        ...
        private Ice.AsyncResult<MCS.Callback_UserManagment_SetUserPW> begin_SetUserPW(int nUID, string pass, int session, _System.Collections.Generic.Dictionary<string, string> ctx__, bool explicitContext__, Ice.AsyncCallback cb__, object cookie__)
        {
            checkAsyncTwowayOnly__(__SetUserPW_name);
            IceInternal.TwowayOutgoingAsync<MCS.Callback_UserManagment_SetUserPW> result__ =  new IceInternal.TwowayOutgoingAsync<MCS.Callback_UserManagment_SetUserPW>(this, __SetUserPW_name, SetUserPW_completed__, cookie__);
            if(cb__ != null)
            {
                result__.whenCompletedWithAsyncCallback(cb__);
            }
        ...
        private void SetUserPW_completed__(Ice.AsyncResult r__, MCS.Callback_UserManagment_SetUserPW cb__, Ice.ExceptionCallback excb__)
        {
            int ret__;
            try
            {
        ...
        public Ice.AsyncResult<MCS.Callback_UserManagment_SetUserRithg> begin_SetUserRithg(int nUID, int nRight, int session)
        {
            return begin_SetUserRithg(nUID, nRight, session, null, false, null, null);
        }

        public Ice.AsyncResult<MCS.Callback_UserManagment_SetUserRithg> begin_SetUserRithg(int nUID, int nRight, int session, _System.Collections.Generic.Dictionary<string, string> ctx__)
        {
            return begin_SetUserRithg(nUID, nRight, session, ctx__, true, null, null);
        }

        public Ice.AsyncResult begin_SetUserRithg(int nUID, int nRight, int session, Ice.AsyncCallback cb__, object cookie__)
        {
            return begin_SetUserRithg(nUID, nRight, session, null, false, cb__, cookie__);
        }

        public Ice.AsyncResult begin_SetUserRithg(int nUID, int nRight, int session, _System.Collections.Generic.Dictionary<string, string> ctx__, Ice.AsyncCallback cb__, object cookie__)
        {
            return begin_SetUserRithg(nUID, nRight, session, ctx__, true, cb__, cookie__);
        }

        private const string __SetUserRithg_name = "SetUserRithg";

        public int end_SetUserRithg(Ice.AsyncResult r__)
        {
            IceInternal.OutgoingAsync outAsync__ = (IceInternal.OutgoingAsync)r__;
            IceInternal.OutgoingAsync.check__(outAsync__, this, __SetUserRithg_name);
            if(!outAsync__.wait__())
            {
                try
                {
        ...
        private Ice.AsyncResult<MCS.Callback_UserManagment_SetUserRithg> begin_SetUserRithg(int nUID, int nRight, int session, _System.Collections.Generic.Dictionary<string, string> ctx__, bool explicitContext__, Ice.AsyncCallback cb__, object cookie__)
        {
            checkAsyncTwowayOnly__(__SetUserRithg_name);
            IceInternal.TwowayOutgoingAsync<MCS.Callback_UserManagment_SetUserRithg> result__ =  new IceInternal.TwowayOutgoingAsync<MCS.Callback_UserManagment_SetUserRithg>(this, __SetUserRithg_name, SetUserRithg_completed__, cookie__);
            if(cb__ != null)
            {
                result__.whenCompletedWithAsyncCallback(cb__);
            }
            try
            {
                result__.prepare__(__SetUserRithg_name, Ice.OperationMode.Idempotent, ctx__, explicitContext__);
                IceInternal.BasicStream os__ = result__.ostr__;
                os__.writeInt(nUID);
                os__.writeInt(nRight);
                os__.writeInt(session);
        ...
        private void SetUserRithg_completed__(Ice.AsyncResult r__, MCS.Callback_UserManagment_SetUserRithg cb__, Ice.ExceptionCallback excb__)
        {
            int ret__;
            try
            {
                ret__ = end_SetUserRithg(r__);
            }
            catch(Ice.Exception ex__)
            {
                if(excb__ != null)
        ...
        public static UserManagmentPrx checkedCast(Ice.ObjectPrx b)
        {
            if(b == null)
            {
                return null;
            }
            UserManagmentPrx r = b as UserManagmentPrx;
            if((r == null) && b.ice_isA(ice_staticId()))
            {
                UserManagmentPrxHelper h = new UserManagmentPrxHelper();
                h.copyFrom__(b);
                r = h;
            }
            return r;
        ...
        public static UserManagmentPrx checkedCast(Ice.ObjectPrx b, _System.Collections.Generic.Dictionary<string, string> ctx)
        {
            if(b == null)
            {
                return null;
        ...
        public static UserManagmentPrx checkedCast(Ice.ObjectPrx b, string f)
        {
            if(b == null)
            {
                return null;
        ...
        public static UserManagmentPrx checkedCast(Ice.ObjectPrx b, string f, _System.Collections.Generic.Dictionary<string, string> ctx)
        {
            if(b == null)
            {
                return null;
        ...
        public static UserManagmentPrx uncheckedCast(Ice.ObjectPrx b)
        {
            if(b == null)
            {
                return null;
        ...
        public static UserManagmentPrx uncheckedCast(Ice.ObjectPrx b, string f)
        {
            if(b == null)
            {
                return null;
        ...
        protected override Ice.ObjectDelM_ createDelegateM__()
        {
            return new UserManagmentDelM_();
        }

        protected override Ice.ObjectDelD_ createDelegateD__()
        {
            return new UserManagmentDelD_();
        }

        public static void write__(IceInternal.BasicStream os__, UserManagmentPrx v__)
        {
            os__.writeProxy(v__);
        }

        public static UserManagmentPrx read__(IceInternal.BasicStream is__)
        {
            Ice.ObjectPrx proxy = is__.readProxy();
            if(proxy != null)
            {
                UserManagmentPrxHelper result = new UserManagmentPrxHelper();
                result.copyFrom__(proxy);
                return result;
            }
            return null;
...
namespace MCS
{
    ...
    [_System.CodeDom.Compiler.GeneratedCodeAttribute("slice2cs", "3.4.2")]
    public interface UserManagmentDel_ : Ice.ObjectDel_
    {
        int CreateUser(string user, string pass, int session, _System.Collections.Generic.Dictionary<string, string> context__);
...
namespace MCS
{
    ...
    [_System.Runtime.InteropServices.ComVisible(false)]
    [_System.CodeDom.Compiler.GeneratedCodeAttribute("slice2cs", "3.4.2")]
    public sealed class UserManagmentDelM_ : Ice.ObjectDelM_, UserManagmentDel_
    {
        public int CreateUser(string user, string pass, int session, _System.Collections.Generic.Dictionary<string, string> context__)
        {
        ...
        public int SetUserRithg(int nUID, int nRight, int session, _System.Collections.Generic.Dictionary<string, string> context__)
        {
            IceInternal.Outgoing og__ = handler__.getOutgoing("SetUserRithg", Ice.OperationMode.Idempotent, context__);
            try
            {
                try
                {
...
namespace MCS
{
    ...
    [_System.Runtime.InteropServices.ComVisible(false)]
    [_System.CodeDom.Compiler.GeneratedCodeAttribute("slice2cs", "3.4.2")]
    public sealed class UserManagmentDelD_ : Ice.ObjectDelD_, UserManagmentDel_
    {
        [_System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1031")]
        public int CreateUser(string user, string pass, int session, _System.Collections.Generic.Dictionary<string, string> context__)
        {
            ...
            IceInternal.Direct.RunDelegate run__ = delegate(Ice.Object obj__)
            {
                UserManagment servant__ = null;
                try
                {
                    servant__ = (UserManagment)obj__;
                }
                catch(_System.InvalidCastException)
                {
                    throw new Ice.OperationNotExistException(current__.id, current__.facet, current__.operation);
        ...
        {
            Ice.Current current__ = new Ice.Current();
            initCurrent__(ref current__, "SetUserRithg", Ice.OperationMode.Idempotent, context__);
            int result__ = 0;
            IceInternal.Direct.RunDelegate run__ = delegate(Ice.Object obj__)
            {
                UserManagment servant__ = null;
                ...
                result__ = servant__.SetUserRithg(nUID, nRight, session, current__);
                return Ice.DispatchStatus.DispatchOK;
            };
            IceInternal.Direct direct__ = null;
            try
...
namespace MCS
{
    ...
    [_System.Runtime.InteropServices.ComVisible(false)]
    [_System.CodeDom.Compiler.GeneratedCodeAttribute("slice2cs", "3.4.2")]
    public abstract class UserManagmentDisp_ : Ice.ObjectImpl, UserManagment
    {
        #region Slice operations
        ...
        public int SetUserRithg(int nUID, int nRight, int session)
        {
            return SetUserRithg(nUID, nRight, session, Ice.ObjectImpl.defaultCurrent);
        }

        public abstract int SetUserRithg(int nUID, int nRight, int session, Ice.Current current__);
        ...
        [_System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1011")]
        public static Ice.DispatchStatus CreateUser___(UserManagment obj__, IceInternal.Incoming inS__, Ice.Current current__)
        {
            checkMode__(Ice.OperationMode.Idempotent, current__.mode);
            IceInternal.BasicStream is__ = inS__.istr();
            is__.startReadEncaps();
        ...
        [_System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1011")]
        public static Ice.DispatchStatus SetUserPW___(UserManagment obj__, IceInternal.Incoming inS__, Ice.Current current__)
        {
            checkMode__(Ice.OperationMode.Idempotent, current__.mode);
            IceInternal.BasicStream is__ = inS__.istr();
            is__.startReadEncaps();
        ...
        [_System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1011")]
        public static Ice.DispatchStatus SetUserRithg___(UserManagment obj__, IceInternal.Incoming inS__, Ice.Current current__)
        {
            checkMode__(Ice.OperationMode.Idempotent, current__.mode);
            IceInternal.BasicStream is__ = inS__.istr();
            is__.startReadEncaps();
            ...
            is__.endReadEncaps();
            IceInternal.BasicStream os__ = inS__.ostr();
            int ret__ = obj__.SetUserRithg(nUID, nRight, session, current__);
            os__.writeInt(ret__);
            return Ice.DispatchStatus.DispatchOK;
        }

        [_System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1011")]
        public static Ice.DispatchStatus DeleteUser___(UserManagment obj__, IceInternal.Incoming inS__, Ice.Current current__)
        {
            checkMode__(Ice.OperationMode.Idempotent, current__.mode);
            IceInternal.BasicStream is__ = inS__.istr();
            is__.startReadEncaps();
        ...
        [_System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1011")]
        public static Ice.DispatchStatus GetUserCount___(UserManagment obj__, IceInternal.Incoming inS__, Ice.Current current__)
        {
            checkMode__(Ice.OperationMode.Idempotent, current__.mode);
        ...
        [_System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1011")]
        public static Ice.DispatchStatus GetUserList___(UserManagment obj__, IceInternal.Incoming inS__, Ice.Current current__)
        {
            checkMode__(Ice.OperationMode.Idempotent, current__.mode);
            IceInternal.BasicStream is__ = inS__.istr();
            is__.startReadEncaps();
        ...
        public override Ice.DispatchStatus dispatch__(IceInternal.Incoming inS__, Ice.Current current__)
        {
            ...
            switch(pos)
            {
                ...
                case 5:
                {
                    return SetUserRithg___(this, inS__, current__);
                }
                case 6:
                {
                    return ice_id___(this, inS__, current__);
