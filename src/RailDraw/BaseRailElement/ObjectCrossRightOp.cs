...
namespace BaseRailElement
{
    class ObjectCrossRightOp
    {
        ...
        public void DrawTracker(
            ...
            Point center,
            int radiu,
            CrossRightEle.DIRECTION_CROSS_R _direction)
        {
            if (canvas == null)
            ...
            switch (_direction)
            {
                case CrossRightEle.DIRECTION_CROSS_R.FIRST:
                    ...
                    break;
                case CrossRightEle.DIRECTION_CROSS_R.SECOND:
                    points[0] = center;
                    points[1] = new Point(center.X - radiu, center.Y);
                    break;
                case CrossRightEle.DIRECTION_CROSS_R.THIRD:
                    points[0] = center;
                    points[1] = new Point(center.X, center.Y - radiu);
                    break;
                case CrossRightEle.DIRECTION_CROSS_R.FOUR:
                    points[0] = center;
                    points[1] = new Point(center.X + radiu, center.Y);
                    break;
                case CrossRightEle.DIRECTION_CROSS_R.NULL:
                    break;
            }
            ...
            int interval)
        {
            ...
            switch (_direction)
            {
                ...
                case CrossRightEle.DIRECTION_CROSS_R.SECOND:
                    ...
                    points[3] = PointList[0];
                    rc = new Rectangle(points[1].X, points[1].Y, points[0].X - points[1].X, points[2].Y - points[1].Y);
                    break;
                case CrossRightEle.DIRECTION_CROSS_R.THIRD:
                    points[0] = center;
                    if (lenghtstr > radiu)
        ...
        public int HandleHitTest(
            Point point,
            Point center,
            int radiu,
            CrossRightEle.DIRECTION_CROSS_R _direction)          //角度
        {
            Point[] points = new Point[4];           
            switch (_direction)
            {
