...
namespace BaseRailElement
{
    ...
    {
        public void DrawTracker(Graphics canvas, Point center, int radiu)
        {
            if (canvas == null)
        ...
        public int HitTest(Point point, bool isSelected, Point center, int radiu)
        {
            if (isSelected)
            {
                int handleHit = HandleHitTest(point, center, radiu);
            ...
            Rectangle rc = new Rectangle(center.X, center.Y, radiu, radiu);             //旋转改
        ...
        public int HandleHitTest(Point point, Point center, int radiu)          //角度
        {
            Point[] points = new Point[4];
            points[0] = center;
            points[1] = new Point(center.X + radiu, center.Y);
        ...
        public Rectangle Scale(int handle, int dx, int dy, Point center, int radiu)
        {            
            Point[] points = new Point[4];
            points[0] = center;
            points[1] = new Point(center.X + radiu, center.Y);
